...
module.exports.getEvents = function (cb, next) {
    ...
    pool.getConnection(function (err, conn) {
        ...
        conn.query("SELECT Event.name, Event.description, Event.date, EventLocation.latitude, EventLocation.longitude, EventLocation.name FROM Event INNER JOIN EventLocation ON Event.locationID = EventLocation.locationID", function (err, results) {
            conn.release();
            if (err) {
